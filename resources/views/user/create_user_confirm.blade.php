    ...
    <div class="row justify-content-center align-items-center">
      <div class="col-md-8">
        <div class="col-md-12">
          ...
          <form class="mt-5 bg-light p-4" action="{{ route('user.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
              ...
              <input type="password" name="confirm_password" class="form-control" value="{{$users['confirm_password']}}">
            </div>
